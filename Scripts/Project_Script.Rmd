...
ggplot(ShenaWQ_yearly, aes(x = Year)) +
  ...
  labs(y = "Sediment Load, logged (mg/L)") + 
  annotate(geom = "text",
           label = "2004",
           x = as.numeric(2004),
           y = as.numeric(1500),
...
Keeping in mind that these values are logged, sediment loads were substantially higher in 1996 than any other year measured. There may have been substantial development or other disruption that year. Further analyses should be considered cautiously because this one outlier year may impact results. We should not exclude it from consideration, because the prior ten years are not available so it could be indicative of a longer trend.
