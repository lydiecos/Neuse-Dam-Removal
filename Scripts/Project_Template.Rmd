...
#+ Have levels increased since dam removal, or did they spike and then stabilize?
...
ggplot(data = ShenaWQ_processed[ShenaWQ_processed$Date > "1995-01-01",], 
  ...
  geom_smooth(method = "lm") +
  scale_y_log10() 
# Sediment levels have clearly not increased over time!
...
t.test_nitrogen
# Sediment levels were significantly lower post (p < 0.001)
# Not possible to see whether there was a spike immediately after dam 
# removal because of gap in data
