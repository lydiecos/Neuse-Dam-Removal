...
# Summary is doing weird things. Check the head
head(ShenaWQ_processed)
# THIS IS A MESS! Why are all my columns lists??

# Tried a couple things but they're not helping...
#ShenaWQ_processed$Calcium_mg.L <- as.numeric(unlist(ShenaWQ_processed$Calcium_mg.L))
